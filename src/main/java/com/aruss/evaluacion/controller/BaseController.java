...
public class BaseController {
	...
	public ResponseEntity getBase() {
		...
		baseEntity.setsDescription("Example for microservice method get");
		
		response = AppCommon.generateResponseOk(lStartTime, baseEntity);
	...
	public ResponseEntity postBase() {
		...
		BaseEntity baseEntity = new BaseEntity();
		baseEntity.setiIdMessage(1L);
		baseEntity.setsDescription("Example for microservice method post");
