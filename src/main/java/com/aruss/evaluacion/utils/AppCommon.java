...
public final class AppCommon {
    ...
    public static Map generateResponseError(int iCodeError, String sDescriptionError, String sStackTrace, List sDiagnostics) {    	
        ...
        logger.error("Fecha y hora de ejecuión: " + simpleDateFormat.format(new Date()) + "Ocurrio un error en el método: generateResponseError " + sStackTrace);
        return response;
    }
    ...
    private static String getDetailException(Exception exception) {
        try {
            ...
            logger.error("Fecha y hora de ejecuión: " + simpleDateFormat.format(new Date())  + sClassError.concat(AppConstantes.GUION_BAJO_ESPACIO).concat(sMethodError).concat(AppConstantes.GUION_BAJO_ESPACIO).concat(sMessageError).concat(AppConstantes.GUION_BAJO_ESPACIO).concat("Linea: ").concat(String.valueOf(iNumberLineException)));
            ...
            return "Clase o método desconocido";
        }
    }
    ...
    public static Map generateResponseOk(long lStartTime, Object data) {
        ...
        logger.info("Fecha y hora de ejecuión: " + simpleDateFormat.format(new Date()) + "Timpo de ejecución : " + String.valueOf((new StringBuilder(String.valueOf(lEndTime - lStartTime))).append(" ms").toString()));
